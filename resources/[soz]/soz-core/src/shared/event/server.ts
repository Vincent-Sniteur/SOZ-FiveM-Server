export enum ServerEvent {
    ...
    ADMIN_END_SPECTATE_PLAYER = 'soz-core:server:admin:end-spectate-player',
    ...
    HOUSING_CHANGE_PRINCIPAL_APARTMENT = 'soz-core:server:housing:change-principal-apartment',
    HOUSING_ADD_ROOMMATE = 'soz-core:server:housing:add-roommate',
    HOUSING_ADD_TENANT = 'soz-core:server:housing:add-tenant',
    ...
    HOUSING_REMOVE_TENANT = 'soz-core:server:housing:remove-tenant',
    ...
    SCENE_ADD_ASSOCIATE = 'soz-core:server:scene:add-associate',
    SCENE_REMOVE_ASSOCIATE = 'soz-core:server:scene:remove-associate',
    SCENE_TRANSFER_OWNER = 'soz-core:server:scene:transfer-owner',
    ...
    UPW_RESELL = 'soz-core:server:job:upw:resell',
    UPW_GET_STORAGE_CAPACITY = 'soz-core:server:job:upw:storage-capacity',
    UPW_CONSUME_RATIO = 'soz-core:server:job:upw:consume-terminal-ratio',
    UPW_ADD_FACILITY = 'soz-core:server:job:upw:add-facility',
    UPW_HARVEST_WASTE = 'soz-core:server:job:upw:harvest-waste',
    ...
    VEHICLE_GYRO_REMOVE = 'soz-core:server:vehicle:gyro-remove',
    ...
    DRUGS_SEEDLING_USE = 'soz-core:server:drugs:seedling-use',
    ...
    GANG_SMUGGLING_BLACK_MARKET_HARVEST = 'soz-core:server:gang:smuggling:black-market-harvest',
    GANG_SMUGGLING_BLACK_MARKET_OWNERS_DELETE = 'soz-core:server:gang:smuggling:black-market-owners-delete',
    GANG_SMUGGLING_BLACK_MARKET_OWNERS_ADD = 'soz-core:server:gang:smuggling:black-market-owners-add',
    ...
    GANG_CYBER_CRYPTO_DESTROY_ADMIN = 'soz-core:server:gang:cyber:destroy-admin',
    ...
    LASER_GAME_NOTIFY_ADD_PLAYER = 'soz-core:server:phone:app:laser-game:notify-add-player',
    LASER_GAME_ADD_PLAYER = 'soz-core:server:phone:app:laser-game:add-player',
    LASER_GAME_START = 'soz-core:server:phone:app:laser-game:start',
    LASER_GAME_CANCEL = 'soz-core:server:phone:app:laser-game:cancel',
    LASER_GAME_LEAVE_GAME = 'soz-core:server:phone:app:laser-game:leave',
    LASER_GAME_REJOIN_GAME = 'soz-core:server:phone:app:laser-game:rejoin',
    LASER_GAME_TP_IN_HUB = 'soz-core:server:phone:app:laser-game:teleport-in-hub',
    LASER_GAME_TP_OUT_HUB = 'soz-core:server:phone:app:laser-game:teleport-out-hub',
    LASER_GAME_SET_PLAYER_COLOR = 'soz-core:server:phone:app:laser-game:set-player-color',
    LASER_GAME_SET_TEAM_COLOR = 'soz-core:server:phone:app:laser-game:set-team-color',
    LASER_GAME_SET_SCORE_GOAL = 'soz-core:server:phone:app:laser-game:set-score-goal',
    ...
    CASINO_CLAIM_BUNDLE = 'soz-core:server:casino:claim-bundle',
